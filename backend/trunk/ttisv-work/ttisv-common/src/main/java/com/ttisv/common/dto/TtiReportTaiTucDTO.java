...
public class TtiReportTaiTucDTO implements Serializable {
	...
	private String insuranceproductcodeTL;//Tai nạn người ngồi trên xe
	...
	private String feeAfterVatTTNDSTN;

	private String feetaxTTNDSTN;

	private String feeBeforeVatTTNDSTN;

	private String feeAfterVatTTNDSBB;

	private String feetaxTTNDSBB;

	private String feeBeforeVatTTNDSBB;
	...
	public String getFeeAfterVatTTNDSTN() {
		return feeAfterVatTTNDSTN;
	}

	public void setFeeAfterVatTTNDSTN(String feeAfterVatTTNDSTN) {
		this.feeAfterVatTTNDSTN = feeAfterVatTTNDSTN;
	}

	public String getFeetaxTTNDSTN() {
		return feetaxTTNDSTN;
	}

	public void setFeetaxTTNDSTN(String feetaxTTNDSTN) {
		this.feetaxTTNDSTN = feetaxTTNDSTN;
	}

	public String getFeeBeforeVatTTNDSTN() {
		return feeBeforeVatTTNDSTN;
	}

	public void setFeeBeforeVatTTNDSTN(String feeBeforeVatTTNDSTN) {
		this.feeBeforeVatTTNDSTN = feeBeforeVatTTNDSTN;
	}

	public String getFeeAfterVatTTNDSBB() {
		return feeAfterVatTTNDSBB;
	}

	public void setFeeAfterVatTTNDSBB(String feeAfterVatTTNDSBB) {
		this.feeAfterVatTTNDSBB = feeAfterVatTTNDSBB;
	}

	public String getFeetaxTTNDSBB() {
		return feetaxTTNDSBB;
	}

	public void setFeetaxTTNDSBB(String feetaxTTNDSBB) {
		this.feetaxTTNDSBB = feetaxTTNDSBB;
	}

	public String getFeeBeforeVatTTNDSBB() {
		return feeBeforeVatTTNDSBB;
	}

	public void setFeeBeforeVatTTNDSBB(String feeBeforeVatTTNDSBB) {
