...
public class NumberReader {
    ...
    public static String read(String a, String currencyCode){
    	
    	HashMap<String, String> mapCurrency = new HashMap<String, String>();
    	mapCurrency.put("VND", "đồng");
		mapCurrency.put("USD", "đô-la Mỹ");
		mapCurrency.put("EUR","euro");
		
		if (mapCurrency.get(currencyCode) == null) {
			mapCurrency.put(currencyCode, currencyCode);
		}
    	
    	ArrayList<String> list = NumberReader.readAsList(a);
    	...
    	return word.substring(0,1).toUpperCase()+ word.substring(1).toLowerCase() + mapCurrency.get(currencyCode) ;
    }
    //Hàm chính đọc số
    public static ArrayList<String> readAsList(String a)
    {
    ...
    public static void main(String[] args) {
		System.out.println(read("1000","VND"));
	}
}
